          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                ...
                <div class="form-group">
                  <label for="">CURP: 123456789012345678</label>
                </div>
                <div class="form-group">
                  <label for="">Numero de Licencia: 123456789012</label>
                </div>
                <div class="d-flex justify-content-end">
            ...
            <form id="formActualizar">
              <div class="row mb-3">
                ...
                <div class="col-md-4">
                  ...
                  <input type="text" class="form-control" value="123456789012345678" maxlength="18" required>
                </div>
                <div class="col-md-4">
                  <label class="form-label">Numero de Licencia</label>
                  <input type="text" class="form-control" value="123456789012" maxlength="12" required>
                </div>
              </div>
            </form>
          </div>
    ...
    <div class="modal fade" id="modalEliminar" tabindex="-1" aria-labelledby="modalEliminarLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>¿Esta seguro que desea eliminar al chofer con ID <strong>1</strong>?</p>
